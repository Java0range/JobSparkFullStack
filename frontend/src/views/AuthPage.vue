...
<template>
  ...
  <div v-if="loginWindowFlag" class="h-1/2 w-1/3 bg-white fixed left-1/2 -translate-x-1/2 top-52 rounded-2xl p-10 flex flex-col items-center justify-center shadow-2xl max-xl:w-2/4 max-md:w-3/4 max-sm:w-full">
    ...
    <div class="relative z-0 w-3/4 mb-5 group">
      <input type="text" name="floating_first_name" class="w-full block py-2.5 px-0 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-sky-500 peer" placeholder=" " required />
    ...
    <div class="relative z-0 w-3/4 mb-8 group">
      <input type="password" name="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-sky-500 peer" placeholder=" " required />
    ...
    <button class="bg-sky-500 hover:bg-green-400 text-white font-bold py-2 px-4 rounded-full transition-all">
      Вход
    </button>
